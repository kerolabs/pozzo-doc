...
| **Acceptance Criteria** | **Escenario 1: Diseño adaptable**<br>Dado que el visitante abre el landing page en una pantalla de 360 píxeles de ancho o más,<br>Cuando lo recorre,<br>Entonces todo el contenido se lee sin desplazamiento horizontal y las llamadas a la acción se alcanzan con una mano.<br><br>**Escenario 2: Navegación entre secciones**<br>Dado que el visitante está en el landing page,<br>Cuando usa el menú de navegación,<br>Entonces el sistema lo lleva a la sección elegida y el menú permanece accesible en todo momento. | | |

#### Technical Stories

Las Technical Stories describen los servicios RESTful de desarrollo propio que sostienen la aplicación móvil. Se redactan desde el rol de desarrollador y sus criterios de aceptación son escenarios de solicitud y respuesta.

| Story ID | User | Priority | Epic |
| :---------------- | :-------------------------------------------------------- | :----------- | :----------- |
| TS01 | Desarrollador | Alta | EP11 |
...
| BG02 | Alcanzar que al menos el 80 % de los aportes de cada ciclo se validen sin revisión manual de la cabeza de junta, en las juntas piloto, dentro de los 3 primeros meses. |
...
#### Business Goal 02: aportes validados sin revisión manual
...
| Sofia Gonzales | Transfiere el monto exacto al destinatario correcto, de modo que el comprobante coincide con lo esperado. | EP05 Registro y validación de aportes<br>EP02 Configuración de la junta | US25 Como participante, deseo que mi aporte quede validado al instante cuando el comprobante coincide, para no depender de la revisión de la cabeza.<br>US08 Como cabeza de junta, deseo indicar el número de Yape o Plin al que deben llegar los aportes, para que Pozzo valide contra ese destinatario. |
...
| Anna Weber | Registra en la aplicación los aportes que recibe en efectivo, para que el pozo refleje todos los aportes. | EP05 Registro y validación de aportes | US27 Como cabeza de junta, deseo registrar el aporte de quien me entregó el dinero en efectivo, para que el pozo refleje todos los aportes. |
| Equipo de desarrollo | Cuenta con una lectura de comprobantes confiable para Yape y Plin. | EP12 Investigación técnica<br>EP11 Servicios RESTful | SP01 Como equipo de desarrollo, deseo investigar y prototipar la lectura automática de comprobantes, para decidir con evidencia cómo implementar la validación.<br>TS05 Como desarrollador, deseo contar con endpoints para registrar y validar aportes, para que el estado del pozo se calcule en el servidor. |
...
| Equipo de desarrollo | Envía notificaciones confiables aunque la aplicación esté cerrada. | EP12 Investigación técnica<br>EP11 Servicios RESTful | SP02 Como equipo de desarrollo, deseo investigar las notificaciones push y la programación de recordatorios, para implementarlos de forma confiable.<br>TS07 Como desarrollador, deseo contar con el registro de dispositivos y un programador de recordatorios, para que las notificaciones lleguen con la aplicación cerrada. |

#### Business Goal 04: discrepancias resueltas en la aplicación
...
| Anna Weber | Consulta el registro de aportes de la junta en lugar de reconstruir la cuenta de memoria o pedir capturas. | EP06 Transparencia del pozo | US32 Como integrante, deseo revisar los períodos ya cerrados, para reconstruir qué pasó en un turno pasado.<br>US29 Como integrante, deseo ver el estado del pozo del período vigente, para tener la misma información que todos. |
| Anna Weber | Registra en la aplicación las coberturas y deserciones, de modo que el registro siempre cuadra con el dinero. | EP08 Entrega del pozo y cierre del ciclo | US37 Como cabeza de junta, deseo registrar que alguien cubrió el aporte de un moroso, para que el pozo se complete y quede constancia de quién puso el dinero.<br>US38 Como cabeza de junta, deseo registrar una deserción y su reemplazo, para que el ciclo pueda continuar. |
| Equipo de desarrollo | Conserva los comprobantes y el historial de cada aporte de forma consultable. | EP11 Servicios RESTful | TS06 Como desarrollador, deseo contar con endpoints para registrar la entrega del pozo, coberturas y deserciones, para que el avance de la junta quede registrado de forma consistente. |

#### Business Goal 05: juntas nuevas por integrantes que ya usaron Pozzo

| Actor | Impact | Deliverable | User Stories |
| :----------- | :------------------------------------------- | :------------------------------ | :--------------------------------------------------------------------------------------------------------------------------------------------- |
| Sofia Gonzales | Presenta su historial de cumplimiento en Pozzo al entrar a una junta nueva, en lugar de depender de la palabra de quien la recomienda. | EP09 Historial de cumplimiento | US40 Como participante, deseo ver mi historial de aportes puntuales, atrasados y cubiertos, para acreditar mi cumplimiento.<br>US41 Como participante, deseo compartir un resumen verificable de mi historial, para que me acepten en una junta nueva. |
| Sofia Gonzales | Propone Pozzo a la cabeza de su siguiente junta. | EP10 Landing page<br>EP03 Incorporación de integrantes | US43 Como visitante, deseo entender en pocos segundos qué problema resuelve Pozzo, para decidir si me interesa para mi junta.<br>US46 Como visitante que abre el enlace desde el celular, deseo que el landing page se lea bien en pantalla pequeña, para no abandonarlo. |
| Anna Weber | Revisa el historial de quienes se unen y acepta integrantes con respaldo, incluso en juntas de mayor monto. | EP09 Historial de cumplimiento | US42 Como cabeza de junta, deseo ver el historial de cumplimiento de quien entra a mi junta, para decidir con información si lo acepto. |
| Anna Weber | Abre un nuevo ciclo con el mismo grupo al terminar el anterior. | EP08 Entrega del pozo y cierre del ciclo | US39 Como cabeza de junta, deseo que la junta se cierre al entregar el último pozo, para tener el resumen del ciclo y abrir uno nuevo con el mismo grupo. |
| Visitante | Deja su contacto o descarga la aplicación desde el landing page. | EP10 Landing page | US44 Como visitante, deseo encontrar cómo obtener la aplicación o dejar mi contacto, para empezar a usar Pozzo con mi grupo.<br>US45 Como visitante, deseo saber quiénes están detrás de Pozzo y cómo contactarlos, para confiar en el producto. |
